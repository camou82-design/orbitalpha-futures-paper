...
exports.evaluateCrashRisk = evaluateCrashRisk;
exports.evaluatePumpRisk = evaluatePumpRisk;
function safeRecentWindow(candles, count) {
 ...
 */
function evaluateCrashRisk(input) {
 ...
 */
function evaluatePumpRisk(input) {
    const { candles, atr, isGlobal } = input;
    if (candles.length < 10) {
        return {
            state: "NONE",
