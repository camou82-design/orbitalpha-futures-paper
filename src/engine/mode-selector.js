...
exports.TREND_BEATS_RANGE_MIN_GAP = exports.RANGE_BEATS_TREND_MIN_GAP = exports.MIXED_AMBIGUITY_DELTA = void 0;
exports.evaluateMarketModeSelector = evaluateMarketModeSelector;
function clamp01(n) {
...
exports.MIXED_AMBIGUITY_DELTA = 0.06;
/** RANGE 우세: rc − tc ≥ 이 값. */
exports.RANGE_BEATS_TREND_MIN_GAP = 0.06;
/** TREND 우세: tc − rc ≥ 이 값. */
exports.TREND_BEATS_RANGE_MIN_GAP = 0.06;
function utcSessionProfile(fetchedAt) {
...
function refineMixedTransition(base, marketMode, gap, ctx) {
    ...
    let tier = base.transitionTier ?? "reduced";
    if (probe)
        tier = "probe_only";
    if (base.activeEngine !== "IDLE" && base.newEntryPolicy === "reduced" && !probe)
        tier = "dominant_reduced";
    return {
        ...base,
...
function resolveRouting(marketMode, rangeConfidence, trendConfidence, ctx) {
    ...
    if (marketMode === "MIXED" || marketMode === "TRANSITION") {
        let branch;
        if (Math.abs(gap) < exports.MIXED_AMBIGUITY_DELTA) {
            branch = {
                activeEngine: "IDLE",
                newEntryPolicy: "paused",
        ...
        else if (gap >= exports.RANGE_BEATS_TREND_MIN_GAP) {
            branch = {
                activeEngine: "RANGE",
        ...
        else if (gap <= -exports.TREND_BEATS_RANGE_MIN_GAP) {
            branch = {
                activeEngine: "TREND",
                newEntryPolicy: "reduced",
 ...
 */
function evaluateMarketModeSelector(input) {
    ...
    const riskThrottle = clamp01(dataDegraded ? 0.85 : raw === "NO_TRADE" ? 0.75 : vol * 0.55 + (amb ? 0.15 : 0));
