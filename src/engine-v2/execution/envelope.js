...
exports.buildV2ExecutionAuthorityEnvelope = buildV2ExecutionAuthorityEnvelope;
function buildV2ExecutionAuthorityEnvelope(args) {
    ...
    if (mode === "engine_v2") {
        ...
        return {
            ...
            h4_bias_actual: args.h4_bias_actual ?? "DATA_NOT_READY",
            h1_bias_actual: args.h1_bias_actual ?? "DATA_NOT_READY",
            m15_bias_actual: args.m15_bias_actual ?? "DATA_NOT_READY",
            m5_bias_actual: args.m5_bias_actual ?? "DATA_NOT_READY",
            htf_bias: args.htf_bias ?? { m5: "DATA_NOT_READY", m15: "DATA_NOT_READY", h1: "DATA_NOT_READY", h4: "DATA_NOT_READY", d1: "DATA_NOT_READY" },
            htf_entry_policy: args.htf_entry_policy ?? "NEUTRAL_HTF_DATA_WAIT",
            counter_trend_risk: args.counter_trend_risk ?? false,
