...
exports.evaluateV2AddOnPolicy = evaluateV2AddOnPolicy;
function evaluateV2AddOnPolicy(args) {
    ...
    const shockLockish = judgment.shockPhase === "DOWN_SHOCK" ||
    ...
    if (judgment.regime_final === "RANGE") {
        const sideAtEdge = (side === "long" && judgment.rangePhase === "LOWER") ||
    ...
    if (judgment.regime_final === "TREND") {
        ...
        const trendSideAligned = (side === "long" && (judgment.trendPhase === "UP" || judgment.trendPhase === "PULLBACK")) ||
        ...
        const pyramidAllowed = breakevenStopConfirmed &&
