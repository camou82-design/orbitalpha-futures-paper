...
export function emitV2TradeLifecycleProof(args: Readonly<{
    ...
    console.info(JSON.stringify({
        ...
        held_position_side: args.v2State.heldPositionSide,
        candidate_intent_side: args.v2State.candidateIntentSide,
        has_opposite_to_candidate: args.v2State.hasOppositeToCandidate,
