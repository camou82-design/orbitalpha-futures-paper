...
exports.rangeExecutorEvaluateEntry = rangeExecutorEvaluateEntry;
exports.rangeExecutorEvaluateExit = rangeExecutorEvaluateExit;
...
function rangeExecutorEvaluateEntry(input) {
    ...
    const box_position = (0, types_1.classifyRangeZone)(boxPos);
...
function rangeExecutorEvaluateExit(input) {
