...
exports.buildTradeConfidenceScore = buildTradeConfidenceScore;
 ...
 */
function buildTradeConfidenceScore(input) {
    let score = 42;
    const d = {};
    ...
    const btcAlign = (long && (btcB === "up" || btcB === "flat")) || (!long && (btcB === "down" || btcB === "flat"));
    if (btcAlign) {
        score += 6;
