...
exports.emaLastFromCloses = emaLastFromCloses;
exports.roundQtyByInstrumentStep = roundQtyByInstrumentStep;
 ...
 */
function emaLastFromCloses(closes, period) {
 ...
 */
function roundQtyByInstrumentStep(qty, step = 0.000001) {
